  ...
  const content = `
    ...
    <div style="background:#111113;border:1px solid rgba(19,40,83,0.4);border-radius:10px;padding:22px 24px;margin-bottom:28px;">
      ...
      <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr><td style="font-size:12px;color:rgba(255,255,255,0.35);padding:4px 0;width:130px;">Type</td><td style="font-size:14px;color:rgba(255,255,255,0.65);padding:4px 0;">SEPA</td></tr>
